...
namespace MVC2.Models
{
    public class CompanyContext : DbContext
    {
        ...
        {
            optionsBuilder.UseLazyLoadingProxies().UseSqlServer("Data Source=DESKTOP-5KKQVT9\\SS17;Initial Catalog= MyCompany_Mvc;Integrated Security=True;TrustServerCertificate = True;");
        }
